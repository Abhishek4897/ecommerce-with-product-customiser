...
function installer_header(){
	...
	<body>
	<p id="logo"><a href="https://www.anshuwap.com" target="_blank" tabindex="-1">AnshuWap, Inc.</a></p>
	<?php
}
...
switch ($step) {
	...
	case 0:
		...
		installer_header();
		?>
		<p>Welcome to AnshuWap. Before getting started, we need some information on the database. You will need to know the following items before proceeding.</p>
		<ol>
			<li>Database name</li>
			<li>Database username</li>
			<li>Database password</li>
			<li>Database host</li>
			<li>Table prefix (if you want to run more than one AnshuWap in a single database)</li>
		</ol>
		<p>
			...
			Need more help? <a href="https://docs.anshuwap.com/" target="_blank">We got it</a>.
        </p>
	...
	default:
		installer_header();
		?>
		<h1>Error establishing a AAnshuWap instance</h1>
		<p>There is an ready AnshuWap instance in your folder. Please ensure you are doing right thing.</p>
		<p>If you want to reinstall AnshuWap. Please remove files below to then refesh this page again.</p>
		<ol>
