jQuery(document).ready(function(t) {
    ...
    // Auto load templates 
    t('#designer-left>div.row>div.col-md-9 .designer-left-nav li[data-tab="templates"] #template-load-more').trigger("click");
    t('#designer-left>div.row>div.col-md-9 .designer-left-nav li[data-tab="color"]').trigger("click");
    var e = "https://arteno.in/",
        a = {
            e: {
                ...
                controls: {
                    ...
                    drawControls: function(t) {
                        ...
                        if (t.save(), this.hasRotatingPoint)
                            if (null !== l && !0 === l.get("lockPosition")) t.fillStyle = "#f75555", t.fillRect(o, r, this.cornerSize, this.cornerSize), t.drawImage(a.objects.icons.del, o + .1 * this.cornerSize, r + .1 * this.cornerSize, .8 * this.cornerSize, .8 * this.cornerSize);
                            else {
                        ...
                        if (void 0 !== e.e) {
                            ...
                            if (!i.canvas.isDrawingMode) {
                                ...
                                i.lineX.css({
                                    ...
                                    display: "none"
                                }), a.ops.mousedown = !1, i.canvas.set("selection", !0), !1 !== a.ops.moved && null !== a.ops.downon && (i.lineX.hide(), i.lineY.hide());
                ...
                events: function() {
                    ...
                    a.trigger({
                        ...
                        events: {
                            ...
                            "div#designer-left>div.row>div.col-md-9>div.designer-left-nav-wrp>ul.designer-left-nav li[data-tab]": "leftNav",
                            "#designer-general-status": "general_status",
                            "div#designer-left>div.row>div.col-md-9 #designer-side-close": "close_side",
                            ...
                            "#designer-left>div.row>div.col-md-9 .designer-x-thumbn:mouseover,#designer-left .designer-x-thumbn:mouseout": "x_thumbn_preview",
                            '#designer-left>div.row>div.col-md-9 button[data-func="show-categories"]': "x_thumbn_categories",
                        ...
                        leftNav: function(e) {
                            ...
                            if (void 0 !== s && void 0 !== s.canvas) {
                                ...
                                this.getAttribute("data-load") && ("function" == typeof a.design.nav.load[this.getAttribute("data-load")] && a.design.nav.load[this.getAttribute("data-load")](e), this.removeAttribute("data-load")), t("#designer-left .designer-tab-body-wrp.active,#designer-left>div.row>div.col-md-9 ul.designer-left-nav li[data-tab].active").removeClass("active"), t('#designer-left [data-view="preactive"]').removeAttr("data-view"), t(this).addClass("active").prev("li[data-tab]").attr({
                                    "data-view": "preactive"
                        ...
                        close_side: function(e) {
                            t(this).removeClass("active"), t("#designer-left>div.row>div.col-md-9 ul.designer-left-nav li.active, .designer-tab-body-wrp.active").removeClass("active")
                        },
                        resp_file: function() {
                        ...
                        stages: function(e) {
                            ...
                            i && (i != a.current_stage || n) && a.data.stages[i] && (s.hasClass("preview-designs") ? a.func.stage_nav(i) : (s.removeClass("stages-expand preview-designs"), a.active_stage(i, function() {
                                a.design.layers.build(), a.get.el("zoom").val(100 * a.stage().canvas.getZoom()).trigger("input"), a.e.tools.attr({
                                    "data-view": "standard"
                                })
                            })))
                        },
                        ...
                        upload_nav: function(e) {
                            ...
                            "external1" == i && (0 === s.find("iframe").length ? s.html('<iframe src="https://arteno.in/images/"></iframe>') : t(this).hasClass("active") && (s.scrollTop(0), s.find("iframe").get(0).contentWindow.postMessage({
                                action: "scrollTop"
                        ...
                        templates_more: function(t) {
                            ...
                            !0 !== a.ops.templates_loading && this.scrollTop + this.offsetHeight >= this.scrollHeight && (a.post({
                                action: "templates",
                            ...
                            a.get.el("templates-list").append('<i class="designer-spinner white x3 mt1 mb1"></i>'), a.ops.templates_loading = !0)
                            ;
                        ...
                        fillColor: function(t) {
                            ...
                            if (i && i.fill !== this.value) {
                                if ("image" == i.type || "qrcode" == i.type || "text-fx" == i.type) {
                                    if (a.get.el("fill").closest('li[data-tool="fill"]').css({
                                            "border-bottom": "3px solid " + this.value
                        ...
                        svgFillColor: function(e) {
                            ...
                            if (null != s)
                                ...
                                } else t("#designer-color-picker-header i").click()
                        },
                        ...
                        text_effect: function(e) {
                            if (!e.isTrigger) {
                                var i = a.stage().canvas,
                                    ...
                                    r = null;
                                if (s)
                                    if (a.f("Processing.."), t(this.parentNode).find("[data-selected]").attr({
                                            "data-selected": ""
                                        }), t(this).attr({
                                            "data-selected": "true"
                        ...
                        load_fonts: function() {
                            a.tools.lightbox({
                                width: 1020,
                                content: '<iframe src="https://arteno.in/fonts/"></iframe>\t\t\t\t\t\t\t\t\t  <span data-view="loading"><i class="designer-spinner x3"></i> loading</span>'
                            }), t("#designer-lightbox iframe").on("load", function() {
                                this.contentWindow.postMessage({
                                    action: "fonts",
                                    fonts: localStorage.getItem("LUMISE_FONTS")
                                }, "*"), t('#designer-lightbox span[data-view="loading"]').remove()
                            })
                        },
                        ...
                        generateShare: function(e) { //Added for file based share-url
                            ...
                            if (g.find("em.designer-required-msg").remove(), g.find(".designer-cart-param").each(function(e) {
                                ...
                                var f = t("#designer-cart-wrp"),
                                    m = n[0].offsetTop;
                                return f.closest("#designer-product").length > 0 ? (t('#designer-left>div.row>div.col-md-9 .designer-left-nav li[data-tab="product"]').trigger("click"), t("#designer-product").show().animate({
                                    scrollTop: m - 20
                                }, 400)) : f.animate({
                                    scrollTop: m - 20
                        ...
                        t.post("/Designer/publish_cart_ajax", r, function(e, a) {
                            t("#loader_publish").hide(), t("body").css("opacity", "1"), window.location.href = l
                        }), i.preventDefault()
                        },
                

                    }), t('#designer-left>div.row>div.col-md-9 #designer-text *[draggable="true"]').each(function() {
                        a.design.event_add_text(this)
                    }), t('#designer-left>div.row>div.col-md-9 #designer-name_number *[draggable="true"]').each(function() { //Added for name_number feature.
                        a.design.event_add_text(this)
                    });
            ...
            xitems: {
                ...
                response: function(e, i) {
                    ...
                    n.find("i.designer-spinner").remove(), n.find("ul.designer-list-items").append(s), a.render.categories(i, e), n.find('ul.designer-list-items li.designer-xitem:not([data-event="true"])').off("click").on("click", function(t) {
                        t.preventDefault();
            ...
            templates: {
                ...
                load: function(e, i) {
                    void 0 !== e.upload && e.upload.indexOf(".mytpl") > -1 ? (0 !== e.upload.toString().trim().indexOf("http") && (e.upload = a.data.upload_url + e.upload), a.f(a.i("loading") + ".."), t.ajax({
                        url: e.upload,
                        method: "GET",
                        statusCode: {
            ...
            cliparts: {
                ...
                add: function(e, i) {
                    if (e.getAttribute("data-ops")) {
                        a.ops.preventClick = !0, a.f(a.i("loading") + "..");
            ...
            tools: {
                set: function(e) {
                    if (e || (e = a.stage().canvas.getActiveObject()), e) {
                        var i = a.get.el;
                        if (i("transparent").val(void 0 !== e.opacity && null !== e.opacity ? 100 * parseFloat(e.opacity) : 100).trigger("input"), i("rotate").val(void 0 !== e.angle ? e.angle : 0).trigger("input"), i("curved-radius").val(void 0 !== e.radius ? e.radius : 50).trigger("input"), i("curved-spacing").val(void 0 !== e.spacing ? e.spacing : 50).trigger("input"), i("workspace").find(".designer-edit-text").val(e.text ? e.text.trim() : ""), i("font-size").val(e.fontSize ? e.fontSize : 14).trigger("input"), i("letter-spacing").val(void 0 !== e.charSpacing ? e.charSpacing : 0).trigger("input"), i("line-height").val(void 0 !== e.lineHeight ? 10 * e.lineHeight : 10).trigger("input"), "path" == e.type ? i("stroke-width").attr({
                                "data-ratio": "1"
                ...
                toImage: function(e) {
                    var a = e.stage,
                        i = void 0 !== window.devicePixelRatio ? window.devicePixelRatio : 1;
                ...
                lightbox: function(e) {
                    ...
                    var a = t.extend({
                        ...
                        i = '<div id="designer-lightbox" class="designer-lightbox">\t\t\t\t\t\t\t\t<div id="designer-lightbox-body">\t\t\t\t\t\t\t\t\t<div id="designer-lightbox-content" style="min-width:' + a.width + 'px">\t\t\t\t\t\t\t\t\t\t' + a.content + "\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t" + a.footer + '\t\t\t\t\t\t\t\t\t<a class="kalb-close" href="#close" title="Close">\t\t\t\t\t\t\t\t\t\t<i class="fa fa-times"></i>\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="kalb-overlay"></div>\t\t\t\t\t\t\t</div>';
                ...
                svg: {
                    ...
                    replace: function(e, a, i) {
                        void 0 !== e ? (e.find('[fill][data-fill-attr-color="' + i + '"]').attr({
                            ...
                            stopColor: a
                        })) : t("#designer-color-picker-header i").click()
                    },
                    edit: function() {
                        var e = this,
            ...
            func: {
                ...
                notice: function(t, e, i) {
                    ...
                    clearTimeout(a.ops.notice_timer), n.data("working") ? n.stop().append('<span data-type="' + e + '"><i class="fa fa-' + s + '"></i> ' + t + "</span>").animate({
                        opacity: 1,
                        top: 55
                    }, 250) : n.data({
                        working: !0
                    }).stop().html('<span data-type="' + e + '"><i class="fa fa-' + s + '"></i> ' + t + "</span>").css({
                        opacity: 0,
                        top: 0,
                        display: "block"
                    }).animate({
                ...
                update_image_fx: function(t, e, i) {
                    var s = a.get.stage();
                    s.active && (a.f("Processing.."), clearTimeout(a.ops.update_image_fx_timer), a.ops.update_image_fx_timer = setTimeout(function() {
                ...
                generate_design_file: function(e) {
                    var i = a.stage();
                    ...
                    var s = {
                        ...
                        n = [];
                    return a.get.el("stage-nav").find("li[data-stage].active").each(function() {
                ...
                create_canvas: function(e, i) {
                    var s = a.get.el("main"),
                        extra_gap = 587-550,
                        n = e.name,
                        o = s.width() - (a.ops.window_width < 1025 ? 0 : 20),
                        r = s.height() - (a.ops.window_width < 1025 ? -40+extra_gap : 10+extra_gap);
                        console.log('O='+o+'R='+r);
                    s.append('<div id="designer-stage-' + n + '" class="designer-stage canvas-wrapper" style="height: ' + r + 'px;">\t\t\t\t\t\t<canvas id="designer-stage-' + n + '-canvas" width="' + o + '" height="' + r + '"></canvas>\t\t\t\t\t\t<div class="designer-snap-line-x"></div>\t\t\t\t\t\t<div class="designer-snap-line-y"></div>\t\t\t\t\t</div>'), e.canvas = new fabric.Canvas("designer-stage-" + n + "-canvas", {
                ...
                load_product: function(t) {
                    ...
                    if (donow = function(e) {
                            ...
                            e.template = t.template), e.saved_stages = t.stages, a.render.product(e, function() {
                                !0 !== a.ops.first_completed && (a.actions.do("first-completed"), a.ops.first_completed = !0), a.func.update_state()
            ...
            render: {
                ...
                fonts: function(e) {
                    ...
                    window.lumise_render_text = function(e, i) {
                        if (!(t('#designer-text-ext li[data-family="' + e + '"]').length > 0)) {
                            var s = t('<span data-family="' + e + '" draggable="true" data-act="add" data-ops=\'[{"type":"i-text", "fontSize": "30", "fontFamily": "' + e + '", ' + (void 0 !== i ? '"font": "' + i.replace("\\", "/") + '",' : "") + '"textAlign": "center", "text": "' + e + '"}]\'>\t\t\t\t\t\t\t<svg width="10" height="30" xmlns="http://www.w3.org/2000/svg" \t\t\t\t\t\t\t\txmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="none">\t\t\t\t\t\t\t\t<g>\t\t\t\t\t\t\t\t\t<text fill="#000000" stroke="none" stroke-width="0" stroke-linecap="round" \t\t\t\t\t\t\t\t\t\tstroke-linejoin="round" x="0" y="30" text-anchor="middle" \t\t\t\t\t\t\t\t\t\t\tfont-size="30px" font-family="' + e + '">\t\t\t\t\t\t\t\t\t\t<tspan x="50%" dy="0">' + e + "</tspan>\t\t\t\t\t\t\t\t\t</text>\t\t\t\t\t\t\t\t</g>\t\t\t\t\t\t\t</svg>\t\t\t\t\t\t</span>");
                ...
                i.length > 1 && (i.unshift('<li data-nav="prev" data-tip="true"><button class="products_sides" data-svg="prev">Front </button><span></span></li>'), i.push('<li data-nav="next" data-tip="true"><button class="products_sides" data-svg="next">Back </button><span></span></li>')), i = a.apply_filters("stage_nav", i)), a.get.el("stage-nav").find(">ul").html(i.join("")).css({
                ...
                product: function(e, i, s) {
                    ...
                    a.data.cfgprinting = o.cfgprinting, o.cfgprinting && (a.data.printings_cfg = o.printings_cfg), a.data.printings = o.printings, a.func.set_url("product", e.id), t("#product_base").val(e.id), void 0 !== e.product && 0 !== e.product && a.func.set_url("product_cms", e.product), a.get.el("main").find(".designer-stage,#designer-no-product").remove(), a.get.el("navigations").find("ul[data-block] li.active").removeClass("active"), a.active_stage(a.render.stage_nav(), function() {
                        var e = a.stage();
                        if (void 0 !== a.data.share) a.f("_loading"), t.get(a.data.upload_url + "shares/" + a.data.share + ".mytpl", function(e) {
                            try {
                                e = JSON.parse(e)
                            } catch (t) {
                                e = {}
                                    ...
                                    switch (n) {
                                        case "item":
                                            t(".designer-categories-wrp").attr({
                                                "data-process": "true"
                                            }), a.ops[s + "_category"] = i.data("id"), a.ops[s + "_index"] = 0, a.ops[s + "_loading"] = !1, a.get.el(s + "-list").find("ul").html(""), a.get.el(s + "-list").trigger("scroll")
                                    }
                                    e.preventDefault()
                                }
                            }
            ...
            response: {
                templates: function(t) {
                    ...
                    a.get.el("templates-list").find("i.designer-spinner").remove(), a.get.el("templates-list").find("ul.designer-list-items").append(e), a.render.categories("templates", t), a.templates.add_events()
                ...
                shapes: function(e) {
                    if (e.error) return a.func.notice(e.error, "error");
                    if (t("#designer-shapes i.designer-spinner").remove(), e.items && e.items.length > 0) {
                ...
                list_products: function(e) {
                    ...
                    o.push("</ul>"), i.html(n.join("")).append(o.join("")), i.find("img[data-template]").on("load", function(e) {
                        ...
                        var i = a[0],
                            ...
                            l = n * i.width,
                            c = n * i.height;
                        t(this).after('<span style="top: ' + o + "px; left: " + r + "px; width: " + l + "px; height: " + c + "px;border-radius: " + n * i.radius + 'px" data-view="template">\t\t\t\t\t\t\t<img style="top: ' + n * s.offset.top + "px; left: " + n * s.offset.left + "px; height: " + n * s.offset.height + "px; width: " + n * s.offset.width + 'px; position: absolute;" src="' + s.screenshot + '" />\t\t\t\t\t\t</span>')
                    }), a.trigger({
                ...
                if (!0 !== e) {
                    if (!a.ops.excmobile) {
                        ...
                        if (i < 450) {
                            ...
                            var o = t("div#designer-left>div.row>div.col-md-9 .designer-left-nav,#designer-top-tools");
                            t("div#designer-left>div.row>div.col-md-9 .designer-left-nav").width() < 450 && (o = t("#designer-top-tools")), o.on("mousedown touchstart", function(e) {
                                ...
                                t("div#designer-left>div.row>div.col-md-9 .designer-left-nav").css({
                                    left: "0px"
                                })
                                ...
                                "max-width": s - 224 + "px"
                            }), t("div#designer-left>div.row>div.col-md-9 .designer-tab-body-wrp").css({
                                height: s - 110 + "px"
                            }), t("#designer-cart-wrp").css({
                                "max-height": s - 200 + "px"
                            }), 
                            // t("div#designer-left>div.row>div.col-md-9>div.designer-left-nav-wrp,div#designer-stage-nav").css({
                            //     top: s + "px"
                            // }),
                            t("#designer-left>div.row>div.col-md-9 #designer-uploads div[data-tab]").css({
                                height: s - 169 + "px"
                            })
            ...
            active_stage: function(e, i) {
                ...
                a.f("_loading"), fabric.util.loadImage(s.image, function(t) {
            ...
            cart: {
                ...
                sum: function() {
                    var t = this.sum_calc();
                    if(total_side>1) {
                        t.ext += 150; //Manually added for Different side charge.
                    }
                ...
                init: function() {
                    ...
                    }), a.actions.add("checkout", a.cart.checkout), a.actions.add("share", a.cart.share), a.actions.add("wishlist", a.cart.wishlist), a.actions.add("cart_id", a.cart.cart_id),
                    ...
                    }), t("#designer-cart-action").on("click", function(t) {
                ...
                publish_cart: function(e) { //Added for Designer only
                    ...
                    if (u.find("em.designer-required-msg").remove(), u.find(".designer-cart-param").each(function(e) {
                        ...
                        var p = t("#designer-cart-wrp"),
                            g = n[0].offsetTop;
                        return p.closest("#designer-product").length > 0 ? (t('#designer-left>div.row>div.col-md-9 .designer-left-nav li[data-tab="product"]').trigger("click"), t("#designer-product").show().animate({
                            scrollTop: g - 20
                        }, 400)) : p.animate({
                            scrollTop: g - 20
                        }, 400), a.func.notice(a.i(179), "error", 3500), delete c, delete r, !1
                ...
                add_cart: function(e) {
                    ...
                    return c = a.apply_filters("cart_data", c), r = a.apply_filters("cart_design", r), localStorage.setItem("MYCART-DATA", JSON.stringify(c)), r.id = l, a.indexed.save([r], "cart"), delete r, delete c, a.cart.do_checkout(e), a.render.cart_change(), a.actions.do("add-cart", l), null != e && "function" == typeof e.preventDefault && e.preventDefault(), !0
                },
                ...
                calc: function(e) {
                    ...
                    try {
                        ...
                        parseFloat(a.cart.qty) < parseFloat(n.minqty) && (a.cart.qty = parseFloat(n.minqty)), parseFloat(a.cart.qty) > parseFloat(n.maxqty) && (a.cart.qty = parseFloat(n.maxqty))
                    } catch (t) {}
                ...
                checkout: function(e) {
                    ...
                    i.append("action", "checkout"), i.append("ajax", "frontend"), i.append("nonce", "ANSHUWAP-NONCE:" + a.data.nonce), Object.keys(e).map(function(t) {
                    ...
                    }), delete e, a.f("0% complete"), t.ajax({
                        data: i,
                        type: "POST",
                        url: a.data.ajax,
                        contentType: !1,
                        ...
                        success: function(e, i) {
                            ...
                            "0" == e ? alert("Error: could not added in cart this time") : window.location.href = e
                        },
                        error: function() {
                            alert("Error: could not added in cart this time")
                        }
                    })
                },
                share: function(e) {
                    ...
                    i.append("action", "share"), i.append("ajax", "frontend"), i.append("nonce", "ANSHUWAP-NONCE:" + a.data.nonce), Object.keys(e).map(function(t) {
                        ...
                        success: function(e, i) {
                            ...
                            console.log(JSON.parse(e).screenshot.front);
                ...
                fields: {
                    render: function(e) {
                        ...
                        var n = t('<div data-type="' + e.type + '" data-id="' + (void 0 !== e.id ? e.id : "") + '" class="designer-cart-field field-inline">\t\t\t\t\t\t\t<div class="designer_form_group">\t\t\t\t\t\t\t\t<span class="designer-cart-field-label">' + e.name + ": " + (e.required ? ' <em class="required">*</em>' : "") + '\t\t\t\t\t\t\t\t</span>\t\t\t\t\t\t\t\t<div class="designer_form_content"></div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'),
            ...
            load: function() {
                if ("function" == typeof designer && designer(this)) {
                    ...
                    this.actions.add("object:selected", function(t) {
                        ...
                        return a.get.el("zoom").val(100).trigger("input")
                        ...
                        "" !== a.func.url_var("shares", "") && (a.f("loading"), t.ajax({
                        ...
                        "" !== a.func.url_var("wishlist", "") && (a.f("loading"), t.ajax({
                        ...
                        "" !== a.func.url_var("cart_id", "") && (a.f("loading"), t.ajax({
                        ...
                        // https://arteno.in/product/get_templates_data/4
                        "" !== a.func.url_var("template", "") && (a.f("loading"), t.ajax({
                            ...
                            statusCode: {
                                ...
                                200: function(t) {
                                    if (null === t) return a.func.notice(a.i(166), "error", 3500), void a.f(!1);
                                    a.func.clear_url(["template"]), a.func.load_product({
                                        id: t.product,
                                        cms: t.product_cms,
                                        printing: t.printing,
                                        options: t.options,
                        ...
                        "" != a.func.url_var("cart", "") ? a.get.el("general-status").html('<span>\t\t\t\t\t\t\t<text><i class="fa fa-exclamation-triangle"></i> ' + a.i(115) + '</text> \t\t\t\t\t\t\t<a href="#clear-designs" data-btn="cancel" data-func="clear-designs">\t\t\t\t\t\t\t\t' + a.i(185) + "\t\t\t\t\t\t\t</a>\t\t\t\t\t\t</span>") : "" !== a.func.url_var("order_print", "") && (t("#designer-general-status").html('<span>\t\t\t\t\t\t\t<text>\t\t\t\t\t\t\t\t<i class="fa fa-exclamation-triangle"></i> ' + a.i(122) + " #" + a.func.url_var("order_print") + "</text>\t\t\t\t\t\t</span>"), "" !== a.func.url_var("design_print", "") && (a.f("loading"), t.ajax({
                            url: a.data.upload_url + "designs/" + a.func.url_var("design_print", "") + ".mytpl",
                            method: "GET",
                            dataType: "JSON",
                            statusCode: {
                                403: a.response.statusCode[403],
                        ...
                        }))), a.func.set_url("share", null), t("#designer-left>div.row>div.col-md-9 ul.designer-left-nav>li[data-tab]").eq(1).click()
