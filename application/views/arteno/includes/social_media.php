...
<div  style="padding: 10px; display: inline-flex;">
    <!--facebook-->
	<div class="social-icon-container" style="outline:none!important;">
	    <a href="<?= $fb_designer_share_url ?>" target="_blank" class="text-white" id="fb_share_url" style="outline:none!important; border:0px!important;box-shadow:none;">
	...
	<div class="social-icon-container">
	    <a href="<?= $whatsapp_designer_share_url ?>" target="_blank" data-action="share/whatsapp/share" class="text-white" id="whatsapp_share_url" style="outline:0px!important;border:0px!important">
		<div aria-label="whatsapp" role="button" tabindex="0" class="SocialMediaShareButton SocialMediaShareButton--whatsapp">
			<div style="width: 30px; height: 30px;">
				<svg viewBox="0 0 64 64" width="30" height="30" class="social-icon social-icon--whatsapp ">
					<g>
						<circle cx="32" cy="32" r="31" fill="#2cb742"></circle>
					</g>
					<g>
	...
	<!--telegram-->
	<div class="social-icon-container">
	     <a href="<?= $telegram_designer_share_url ?>" target="_blank" class="text-white" id="telegram_share_url" style="outline:0px!important;border:0px!important">
        <div style="width: 30px; height: 30px;">
    <svg
      viewBox="0 0 64 64"
      width="30"
    ...
    >
      <g><circle cx="32" cy="32" r="31" fill="#37aee2"></circle></g>
      <g>
        <path
	...
	<div class="social-icon-container">
	    <div style="width: 30px; height: 30px;">
            <a href="https://www.instagram.com/arteno_official/?hl=en" target="_blank" class="text-white" id="instagram_share_url" style="outline:0px!important;border:0px!important">
                <img src="https://www.arteno.in/assets/ig.png" alt="">
            </a>
        </div>
	</div>
	<!--twitter-->
	<div class="social-icon-container">
	   <a href="<?= $twitter_designer_share_url ?>" target="_blank" class="text-white" id="twitter_share_url" style="outline:0px!important;border:0px!important">
