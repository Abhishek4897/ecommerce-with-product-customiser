...
<section style="margin-top:10px !important;">
   <div class="container-fluid">
       <form action="<?=base_url()?>Checkout/re_place_order/" id="myform" method="post">
      <div class="row">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="card payment-card  border-0" style=" text-align:center; background:transparent !important;">
                     <center>
                        <div class="card-body" style="background:transparent !important;padding-left:0px">
                           <div>
                  ...
                  <div class="card bg-light mb-3" style="max-width: 100%;">
                     ...
                     <div class="card-body order-scroll" >
                        <?php 
                           ...
                           foreach($cart as $c):
                                // print_r($c);
                                $side_charge_p = $template_p = 0;
                                $product = related_base($c->product_base);
                                if($c->temp_id!="0" || $c->back_temp_id!="0"):
                                    $des_charge = designer_charge($product->id)->price;
                                    if($c->temp_id!="0" && $c->back_temp_id!="0"):
                                        $template_p = 2*$des_charge;
                                        $side_charge_p = $product->backSideCharge;
                                    endif;
                                    $template_p = $des_charge;
                                endif;
                                $p = (object)array("total" => $c->total_price, "base" => $c->product_price, "template" => $template_p, "side_charge" => $side_charge_p);
                                $slug = $product->slug;
                                $img ='';
                                foreach(json_decode($c->screenshots) as $image){
                                    $img = $img .'<img src="'.base_url('/uploads/orders/').'/'.$image.'" alt="item" >';
                                }
                        ...
                        <div style="padding-top:10px;">
                           <div class="row">
                              ...
                              <div class="col-lg-8 col-md-8 col-8 my-order-section">
                                 <div class="row">
                                    <div class="col-12">
                                       <h4 class="my-order-product p-name-text"><?= ucwords(strtolower($c->product_name))?></h4>
                                    </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="row text-center mt-2">
                           <div class="col-12">
                              ...
                              <!--</a>-->
                              <!--<button class="btn btn-primary text-uppercase text-center btn-lg btn-block checkout-button  order_last order_place_button" style="margin-top:29px;">PLACE ORDER</button>-->
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   var total = parseFloat(parseFloat(gdtotal)+parseFloat(shipping)).toFixed(2);
    var paymentWayClicked = false;
     ...
     if(value1=='cod'){
        ...
        //   $( "button.order_last" ).removeClass( "order_place_button" ).addClass( "openModel" );
        $( "button.view_more" ).removeClass( "submitbtn" ).addClass( "formsubmit" );
         $( "button.order_last" ).removeClass( "openModel" );
...
<!--   <center>-->
<!--      <button type="button"  class="btn btn-light btn-rounded btn-block view_more submitbtn" style="background:black !important;color:white !important;padding:14px;font-size:21px;display:none;"> PLACE ORDER</a>-->
<!--   </center>-->
</div>
