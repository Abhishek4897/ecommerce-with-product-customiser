   ...
   <div class="container-fluid checkout-page-section" style="overflow: hidden;">
      <div class="row text-left mt-5 mb-4">
         <div class="col-12 mt-3">
            <h4 style="margin-top:55px!important;<?=(cart_count()>0)?'':'text-align:center;'?>">MY INFORMATION</h4>
         </div>
      </div>
      <div class="row">
         ...
         <div class="col-lg-8 col-md-8 col-12 tablet-left-section">
            <form action="<?=base_url('home/guest_user')?>" method="post" onsubmit="return validateForm()" style="margin-bottom:.5rem !important;" autocomplete="off">
               <div class="form-row">
                  <div class="col-lg-6 col-md-6 col-12">
                     <h6>Name<span style="color:red;">*</span></h6>
                     <input autocomplete="off" type="text" id="usrname" name="name" class="form-control my-3 p-2 checkout-inputype" value="" required />
                  </div>
                  <div class="col-lg-6 col-md-6 col-12">
                     <h6>Phone number<span style="color:red;">*</span></h6>
                     <input autocomplete="off" id="mobile1" onchange="check_mobileuser(this.value)"  type="text" name="mobile" class="form-control my-3 p-2 checkout-inputype" value="<?=(isset($guest_mobile))?$guest_mobile:''?>" pattern="[6-9]{1}[0-9]{9}" minlength="10" maxlength="10" style="background-color: rgb(234, 234, 234);" required />
                    <!--<span id="lbl_mobile">Please enter valid mobile no.</span>-->
                  </div>
                  <div class="col-lg-6 col-md-6 col-12">
                     <h6>Email<span style="color:red;">*</span></h6>
                     <input autocomplete="off" type="email" id="email1" onchange="check_emailuser(this.value)" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control my-3 p-2 checkout-inputype" value="<?=(isset($guest_email))?$guest_email:' '?>" required>
                  <!--<span id="lbl_email">Please enter valid email address.</span>-->
                  </div>
                  <div class="col-lg-6 col-md-6 col-12">
                     <h6>Password<span style="color:red;">*</span></h6>
                     <input autocomplete="off" id="password" type="password" name="confirmpassword" class="form-control my-3 p-2 checkout-inputype" value="" required>
                     
                  </div>
                    <!--<div class="col-lg-6 col-md-6 col-12" style="display: none">-->
                    <!--    <div class="form-group"> -->
                    <!--        <label for="dob">Date of Birth</label>-->
                    <!--        <input type="text" id="dob" name="dob" placeholder="Date of Birth" class="form-control datapicker" value=""> -->
                    <!--    </div>-->
                    <!--</div>-->
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group"> 
            ...
            <div class="row mb-3">
                ...
                <div class="col-3 mobile-padding-0"> &nbsp; </div>
                <div class="col-6 mobile-padding-0" style="margin-top:0px;margin-bottom:5px;">
                    <?php if(cart_count()==0): ?>
                        <input type="submit" onclick1="payment()" class="btn btn-primary  btn-lg btn-block checkout-button checkout-button-main" value="CONTINUE" />
                    <?php endif; ?>
...
<style>
    ...
    .billing-addr .font-15 a,.shipping-addr label a{
        ...
        display:inline;
                ...
                <div class="col-12 mobile-padding-0" style="display:none">
         ...
         <div class="col-lg-4 col-md-4 col-12  tablet-right-section tablet-mb-rp" style="<?= (cart_count()>0)?'':'display:none' ?>" >
                                        ...
                                        <div class="col-12">
                                            <h4 class="my-order-product p-name-text mobile-three-dots"><?= ucwords(strtolower($cart->product_name))?> 
                                                <!--<span class="float-right" style="position: absolute;top: 0;right:5">-->
                                                    <!--<a href="<?= base_url().'customizer?product='.$cart->id.'&cart_id='.$c_key ?>" class="d-inline"><i class="text-success fas fa-edit"></i></a>-->
                                                    <!--&nbsp;-->
                                                    <!--<i data-cart_id ="<?= $c_key ?>" data-rowid="<?=$t_id[0]?>" style="color:red;cursor:pointer" class="removecart fas fa-trash-alt"></i>-->
                                                <!--</span>-->
                                                </h4>
...
<?= $this->session->flashdata('billlocation'); ?>
<script>
    function check_mobileuser(value){
        var mobile=value;
        if(mobile.length==10){
            $.ajax({
               ...
               data:{mobile:mobile},
                   success:function(response){
                    if(response==1){
                         swal("Your Mobile Number already exist.Please Login.",{
                          icon: "warning",
                          button: false,
                          timer: 1200,
                        }); 
                        $('#mobileloginotpmodal').modal({show:true});
                        $('#mobile_number').val($('#mobile1').val());
    ...
    function check_emailuser(value){
        var email=value;
        $.ajax({
                   ...
                   success:function(response){
                      if(response==1){
                         swal("Your email address already exist.Please Login.",{
                          icon: "warning",
                          button: false,
                          timer: 1200,
                        }); 
