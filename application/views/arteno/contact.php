...
<section  style="padding-top:50px; padding-bottom:0px;">
    <!--<img src="<?= base_url()?>/assets/banners/contact/banner-min.jpg">-->
</section>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="contact-info">
                        ...
                        <ul class="contact-list">
                            ...
                            <li><i class="fas fa-phone" style="transform:rotate(115deg);"></i> Call Us: <a href="tel:+91129-4015046 ">+91 129-4015046 </a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="contact_email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" required
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" id="phone_number" pattern="[6-9]{1}[0-9]{9}"  maxlength="10"class="form-control"
   ...
   $.ajax({
        ...
        success:function(result){
         if(result!=0){
                     ...
                     swal(" You resquest has been sent successfully!",{
                      icon: "success",
                      button: false,
                      timer: 1200,
     });
