...
<section class="second mt-50">
    <div class="container">
        <div class="card border-0" style="background:transparent;">
            <div class="row">
                <div class="col-md-12">
        <center> <h5 class="navigate" style="font-weight: 500;font-size: 30px;">MY DESIGNS</h5>
        ...
        <div class="d-block d-xs-block d-sm-none d-md-none d-lg-none">
            <div class="row btngroup tab-padding" style="display:flex;">
                ...
                <div class="col-xs-4 col-4">
                 <form action="" method="post">
                    <button type="submit" name="search" value="<?= $p->id;?>" class="cool-link button-background"><?= $p->name;?></button>
                    </form>
                </div>
                <?php endforeach;?>
            </div>
                     ...
                     <!--<div class="wishlist-close float-right text-danger"><a href="<?= base_url('Designer/delete_design')?>/<?= $d->id?>" onclick="return confirm('Are you sure you want to delete')"><span class="cart-close"><i class="fa fa-trash" aria-hidden="true"></i></span></a></div>    -->
                      ...
                      <div id="product_slider<?= $d->id?>" style="display:none">
                        ...
                        <div class="product-content ">
                            <h3 class="text-left"><a href="<?= ($d->active == 1)?base_url($d->baseslug."/".$d->slug):"" ?>" style="font-weight:500;"><?= $d->name?></a></h3><i class="fa fa-pencil-alt" data-toggle="modal" data-target="#update_name<?= $d->id?>" style="float:right;margin-top:-20px;"></i>
                            <div class="text-left">
