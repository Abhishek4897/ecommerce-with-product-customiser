...
.checkout-button{
   ...
   .thumbnail{
    width: 100%;
    height: <?php $counter=count($cart_data);
            echo ($counter==2)?'155px':'250px;';
            ?>;
   }
   .thumbnail1{
        width: 100%;
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="row">
                                        <?php
                                        $count1=count($cart_data);
                                        ?>
                                        <div class="col-md-4 col-xs-<?= ($count1==1)?'12':'6'?> col-<?= ($count1==1)?'12':'6'?>">
                                            <div class="mobile-flex">
                                            <?php 
                                            $count=count($cart_data);
                                           
                                            $xx = 0; foreach($cart_data as $items): $xx++; ?>
                                                <img src="<?php echo $items['items'] ;?>" class="<?=($count==2)?'thumbnail':'thumbnail1'?>" />
                                                <?= ($xx==1)?"":"" ?>
                                            <?php endforeach; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row mt-15">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name"  maxlength ="30" id="design_name" onkeyup="limitlength(this,20)" style="text-transform: capitalize;"  required>
                                                    </div>
                    					        ...
                    					        <div class="col-md-12">
                    					            ...
                    					            <textarea class="form-control" name="description" style="text-transform: capitalize;" rows='4' cols="2"></textarea>
                    					        </div>
...
$('#counterd').html(obj.value.length);
    if (obj.value.length>maxlength){
        swal("Design name limit over",{
                          icon: "warning",
                          button: false,
                          timer: 1200,
                        });
