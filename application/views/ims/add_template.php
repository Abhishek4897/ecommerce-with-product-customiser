								...
								<div class="card-block">
									<form action="" method="post" enctype="multipart/form-data">
									    <div class="row">
                                            ...
                                            <label for="slider"><span class="dashed-border"><i class="fa fa-picture-o"></i> Screen Shot(.lumi *)</span></label>
                                            
                                        </div>
                                        </div>
                                        <div class="col-md-6">
									            <div class="form-group">
                                            <input type="file"  class="hidden-field" name="picture" id="slider1" onchange="preview1(this)">
                                            <img src="" alt="" id="image1">
                                            <label for="slider1"><span class="dashed-border"><i class="fa fa-picture-o"></i> Image</span></label>
