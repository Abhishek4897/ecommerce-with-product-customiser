			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#!">Template Tag</a>
						</li>
					</ul>
				</div>
			</div>
							...
							<div class="card">
							    <div class="card-header">
									<div class="row">
											...
											<a href="<?php echo base_url()?>Admin/add_template_tag"  class="float-right"><button class="btn btn-primary">+ Add Tag</button></a>
											</div>
