			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#!">Add Designer</a>
						</li>
					</ul>
				</div>
			</div>
                                    ...
                                    <form method="post" action="" class="form-material" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-5 mt-2">
                                                <center><img class="card-img-top profile"  id="image" src="<?=base_url()?>uploads/no_image.jpg" alt="">
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group form-default mt-2">
                                                            <input type="text" name="socity_id" class="form-control"required>
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Socity</label>
                                                        </div>                                            
                                                        <div class="form-group form-default mt-2">
                                                            <input type="text" name="pincode"class="form-control mob_no" data-mask="9999-999-999" required>
                                                            <span class="form-bar"></span>
