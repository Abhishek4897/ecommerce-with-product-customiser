...
<script src="<?php echo base_url() ?>assets1/bower_components/jquery/js/jquery.min.js"></script>
	...
	<script src="<?php echo base_url() ?>assets1/bower_components/bootstrap/js/bootstrap.min.js">
	</script>

	<script
		src="<?php echo base_url() ?>assets1/bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>
