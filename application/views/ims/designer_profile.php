			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#!">Update Designer</a>
						</li>
					</ul>
				</div>
			</div>
                                ...
                                <div class="card-block">
                                    <form method="post" action="" class="form-material" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <div class="card-header"><a href="<?=base_url()?>admin/address/<?=$list->id?>"><h5> Addresses</h5></a></div>
                                                    
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <div class="card-header"><a href="<?=base_url()?>admin/payment_details/<?=$list->id?>"><h5>Payment Details</h5></a></div>
