			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="">Add Payment Details</a>
						</li>
					</ul>
				</div>
			</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                               <div class="form-group form-default mt-2">
                                                            ...
                                                            <input type="text" name="ifsc_code"class="form-control mob_no" data-mask="9999-999-999">
                                                            <span class="form-bar"></span>
                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group form-default mt-2">
                                                            ...
                                                            <input type="text" name="name_on_bank" class="form-control">
                                                            <span class="form-bar"></span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-default mt-2">
                                                            ...
                                                            <input type="text" name="upi_id"class="form-control mob_no" data-mask="9999-999-999">
                                                            <span class="form-bar"></span>
