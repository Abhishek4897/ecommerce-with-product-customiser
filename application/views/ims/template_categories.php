			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#!">Template Categories</a>
						</li>
					</ul>
				</div>
			</div>
							...
							<div class="card">
							    <div class="card-header">
									<div class="row">
											...
											<a href="<?php echo base_url()?>Admin/add_template_categories"  class="float-right"><button class="btn btn-primary">+ Add Category</button></a>
											</div>
												...
												<tr>
													...
													<td>
													 <form action="" method="post" class="del_button">
														 ...
														 <button
														  class="btn waves-effect waves-light btn-danger btn-xs btn-icon btn-custom" type="submit" onclick="return confirm('Are you sure to delete ?')" name="delete" value="categories"><i
