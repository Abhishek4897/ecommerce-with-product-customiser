...
.social-item{
    margin: 0px 20px 6px -7px!important;
}
    ...
    @media only screen and (max-width: 600px) {
        ...
        <div class="modal left fade productsFilterModal" id="myModal" tabindex="-1" role="dialog">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fas fa-times"></i> Close</span></button>
               <div class="modal-body">
        ...
        <div class="bts-popup" role="alert">
         <div class="bts-popup-container">
            ...
            <div class="img-box">
               ...
               <img src="assets/img/women2.png" alt="image">
            </div>
      ...
      <!--mobile sidebar-->
                              ...
                              <div class="modal-body">
                                      ...
                                      <div class="p-3">
                                            <center>
                                             ...
                                             <center><p class="mt-3" style="font-size: 15px; line-height: 19px;"><b>Customize your Premium T-shirts, Mugs & Face-masks connect with designers and browse designer prints!</b></p></center>
                          ...
                          <div class="modal-dialog modal-dialog-centered modal-md custum-modal-height" role="document" style="">
                            <div class="modal-content">
                              <div class="modal-body">
                                      ...
                                      <div class="p-3">
        <div id="otploader"  style="position:absolute; background: rgba(0, 0, 0, 0.3); height:100%; width:100%;display:none; top:0; left:0" role="status" ><img src=" <?=base_url()?>assets/img/unnamed.gif" style="height:20%; width:20%; position:absolute; top:45%;left:45%; "/>   </div>                                    
                                            <center>
                                                 <img src="<?= base_url()?>assets/images/artenologo.png" style="height:60px;">
                                             </center>
                                             ...
                                             <form method="post" id="verify_otp">
                                                 ...
                                                 <div class="form-group mt-4 mb-4" >
                                                    ...
                                                    <input type="number" class="form-control" name="otp" id="otp_value" onkeyup="check_otp_length(this.value)" value="">
                                                  </div>
        ...
        <!-- register modal if user not register modal-->
        <footer class="footer-area" style="padding-bottom: 10px;">
        <div class="container arteno_services">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-xs-6 col-6">
                    <div class="single-footer-widget float-left">
                        <h4 class="text-white text-uppercase fs_20 d-none d-lg-block d-md-block d-sm-block">Follow us</h4>
                    <ul class="social-icon">
                        <li class="social-item"><a href="https://www.facebook.com/Arteno-100223201838813" target="_blank"><i class="fab fa-facebook-square" aria-hidden="true"></i></a></li>
                        <li class="social-item"><a href="https://instagram.com/arteno_official?igshid=1d6y4qxyagwjf" target="_blank"><i class="fab fa-instagram"></i></a></li>
                        <li class="social-item"><a href="mailto:Customersupport@arteno.in"><i class="fa fa-envelope"></i></a></li>
                        
                    </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-6 col-6"></div>
                <div class="col-lg-4 col-md-4 col-xs-6 col-6 customer_services">
                    <div class="single-footer-widget float-left">
                        <h4 class="text-white text-uppercase fs_20">Customer Service</h4>
                        <ul class="footer-menu">
                        <li><a href="<?= base_url()?>contact" class="text-white">Contact Us</a></li>
                        <li><a href="" class="text-white">Order Status</a></li>
                        <li><a href="<?= base_url()?>return_policy" class="text-white">Return Policy</a></li>
                    </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-6 col-6 d-block d-xs-block d-sm-none d-md-none d-lg-none d-xl-none">
                    <img src="<?=base_url('assets/images/icons/made_in_india.png')?>" alt="arteno madein india" class="made_in_india">
                </div>
                
            </div>
           
        </div>
        <hr class="hr_divider" style="    width: 87.5%!important;">
        <div class="container footer_bottom_bar">
                <div class="row">
                    <div class="col-md-12 float-right mobile-padding-25 footer_bottom_area">
                        <div style="display:flex;">
                            <a href="<?= base_url()?>privacy_policy"><span class="text-white footer_links">Privacy Policy</span> </a><span class="text-white footer_links">&nbsp;|&nbsp;</span><a href="<?= base_url()?>term_condition"> <span class="text-white footer_links">Terms & Conditions</span></a>
                            <!--<span class="text-white footer_links dash">&nbsp;|&nbsp;</span><a href="<?= base_url()?>return_policy"> <span class="text-white footer_links">Return Policy</span></a>-->
                            <span class="text-white footer_links dash">&nbsp;|&nbsp;</span><a href="<?= base_url()?>legal"> <span class="text-white footer_links">Legal</span></a>
                            <span class="text-white footer_links dash">&nbsp;|&nbsp;</span><a href="<?= base_url()?>disclaimer"> <span class="text-white footer_links">Disclaimer</span></a>
                        </div>
                    
                        <span class="text-white footer_links">&#169;2021 Arteno Creations (P) Limited. All rights reserved.</span>
                    </div>
                </div>
        </div>
    </footer>
    ...
    <script>
        ...
        <script>
            ...
            function show_slider(id,img) {
                document.getElementById(id).style.display = "block";
                document.getElementById(img).style.display = "none";
            }
            function hide_slider(id,img) {
            ...
            $(document).ready(function(){
                ...
                $("#dashboard_area").show();
                $("#my_store_area").hide();
                $("#designer_dashboard").addClass("menu_item_active");
                $("#my_store").removeClass("menu_item_active");
                $("#designer_dashboard").click(function(){
                    $("#dashboard_area").show();
                    $("#my_store_area").hide();
                    $("#designer_dashboard").addClass("menu_item_active");
                    $("#my_store").removeClass("menu_item_active");
                ...
                $("#my_store").click(function(){
                    $("#dashboard_area").hide();
                    $("#my_store_area").show();
                    $("#my_store").addClass("menu_item_active");
                    $("#designer_dashboard").removeClass("menu_item_active");
                });
            });
        ...
        $.ajax({
            url:"<?= base_url()?>Front/wish_count/",
            method:"POST",
            dataType:"json",
            success:function(r){
                if(r.length>0){
                $(".wishcount").html(r.length);
