			...
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#!">Designer Management</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
																		<div class="row">
											<div class="col-8">
											<h4>Manage Designers</h4>
											</div>
												<div class="col-4">
												<!--<a href="<?php echo base_url()?>Admin/add_designer"><button class="btn btn-square btn-primary waves-effect waves-light" style="float:right">+ Add</button></a>-->
												</div>
									    </div>
								</div>
												...
												<tr>
													...
													<td><a href="mailto:='<?=$l->user_email;?>'"><button class="btn btn-primary btn-ellipse btn-sm"><?=$l->user_email;?></button></a></td>
													 ...
													 <?php if($l->status==1){?>
                                                        ...
                                                        <button
														  class="btn btn-success btn-sm  btn-custom" type="submit" onclick="return confirm('Are you sure to Deactive ?')" name="deactive" value="users">Active</button>
													  </form>  
                                                         </td>
                                                        <?php } else {?>
													  ...
													  <td>
													      <a href="<?php echo base_url() ?>Admin/designer_profile/<?=$l->id?>"><button
														  class="btn waves-effect waves-light btn-primary btn-xs btn-icon btn-custom"><i
															  class="fa fa-pencil b1"></i></button>
													      </a>
													      <a href="<?php echo base_url() ?>Designer/<?= $l->slug ?>" target="_blank">
													          <button class="btn waves-effect waves-light btn-primary btn-xs btn-icon btn-custom"><i class="fa fa-eye b1"></i></button>
													      </a>
                                                        ...
                                                        <button
														  class="btn waves-effect waves-light btn-danger btn-xs btn-icon btn-custom" type="submit" onclick="return confirm('Are you sure to delete ?')" name="delete" value="users"><i
															 ...
															 <?php if($l->featured == 0){ ?>
															  <button
														  class="btn btn-info btn-custom" type="submit" onclick="return confirm('Are you sure to Featured ?')" name="featured" value="users">
															       Featured
															  </button>
															  <?php }else{?>
															  <button
														  class="btn waves-effect  btn-warning btn-custom" type="submit" onclick="return confirm('Are you sure to Unfeatured ?')" name="unfeatured" value="users">
															       Unfeatured
															  </button>
															  <?php }?>
													  </form>
