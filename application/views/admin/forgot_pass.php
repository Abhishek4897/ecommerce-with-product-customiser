<html lang="en">
    ...
    <body themebg-pattern="theme1">
                        ...
                        <form class="md-float-material form-material">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" style="background:#000;border:0px;">Reset Password</button>
                                        </div>
                                    </div>
                                    ...
                                    <!--            <a href="index-2.html"><b>Back to website</b></a>-->
                                    <!--        </p>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-2">-->
                                    <!--        <img src="<?php echo base_url() ?>/assets1/images/auth/Logo-small-bottom.png" alt="small-logo.png" />-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                </div>
                            </div>
        ...
        <!--<script type="text/javascript" src="<?php echo base_url() ?>/assets1/bower_components/modernizr/js/css-scrollbars.js"></script>-->
        <!--<script type="text/javascript" src="<?php echo base_url() ?>/assets1/assets1/js/common-pages.js"></script>-->
    </body>
</html>
