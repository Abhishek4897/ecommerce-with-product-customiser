								...
								<div class="card-block">
									<form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="url"  class="form-control" name="link"  value="<?=$list->youtube_link?>" id="" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="title">Title</label>
                                            <input type="title"  class="form-control" name="title" id="" value="<?=$list->title?>" required>
                                        </div>
                                       <div class="form-group">
