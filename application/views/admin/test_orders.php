...
<div class="pcoded-content">
            ...
            <div class="page-body">
               ...
               <div class="row">
                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                       <?php if($myorder->awb_code==''){if($myorder->status=="cancelled") {?>
                ...
                <label  class="badge badge-primary btn-rounded" style="text-transform:capitalize;"><?= $myorder->status?></label>
                 <?php } } else if($myorder->status=="cancelled"){?>
                 <label  class="badge badge-danger btn-rounded" style="text-transform:capitalize;"><?= $myorder->status?></label>
                 <?php } else {?>
                ...
                <td>
                    ...
                    <?php }  else if($myorder->status=="pending"){ ?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
        <?php if($myorder->status=='confirmed' || $myorder->status=='pending' || $myorder->status=='placed') { 
		...
		<?php }else if($myorder->status=='dispatched'){?>
		    <form action="" method="post" class="del_button">
				<input type="hidden" name="id" value="<?=$myorder->id?>">
		...
		<?php }else if($myorder->status=='completed'){?>
			<form action="" method="post" class="del_button">
			    <input type="hidden" name="id" value="<?=$myorder->id?>">
