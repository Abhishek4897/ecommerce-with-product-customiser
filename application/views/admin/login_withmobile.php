                        ...
                        <div class="card-block">
                           ...
                           <div class="row m-t-25 text-left">
                              <div class="col-12">
                                 ...
                                 <div class="radio-fade fade-in-primary d-">
                                    <label>
                                    <input type="radio" value="<?=$mob->id?>" name="mobile">
                                   
                                    <span class="text-inverse"><?=$mob->mobile_no?></span>
                                    </label>
                           ...
                           <div class="row m-t-30">
                              <div class="col-md-12">
                                 <button name="submit" type="submit" value="1"  class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" style="background:#000;border:0px;">Send OTP</button>
                              </div>
                           </div>
                           <hr />
