                        ...
                        <div class="card-header">
                           <div class="row">
                              <div class="col-8">
                                  ...
                                  $order_delivery=$orderlists->shipping_charge;
                                  $cod_charge = $orderlists->cod_charge;
                                  ?>
                                ...
                                <h6> COD Charges : <?= $orderlists->currency;?> <?= number_format($cod_charge ,2); ?></h6>
                                <h6>  Total GST: <?= $orderlists->currency;?> <?=  number_format($orderlists->total_gst ,2); ?></h6>
                              </div>
                              <div class="col-4">
                                <?php if($orderlists->status!='confirmed' && $orderlists->status=='dispatched' || $orderlists->status=='completed'){?>
                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap">
                                 <thead>
                                    <tr>
                                       ...
                                       <th>Unit Price</th>
                                       <th> Total Price (with Designer Charge.)</th>
                                        <th>Action</th>
              ...
              $gst=$pro_duct[$key];
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                           ...
                                           ?>
                                           <img class="img-fluid img-circle user-thumbnail" src="<?php echo base_url() ?>uploads/orders/<?= $image ?>" alt="" style="height:80px;width:80px;border-radius:0%;margin-top:10px;" data-toggle="modal" data-target="#image<?=$myorder->id?>"><br/>
                                          ...
                                          <?php if($variation[0]!=null) {?>
                                           ...
                                           <?php }?>
                                           <br/><br/>
                                          <?php if($variation[1]=='S' || $variation[1]=='M' || $variation[1]=='L' || $variation[1]=='XL' || $variation[1]=='XXL') {?>
                                           ...
                                           <td><?= $myorder->qty ?></td>
                                           <td>Rate: <?= $gst ?> % <br/>
                                           Rs <?= number_format($myorder->total_price * $gst /100 ,2) ?>
                                           </td>
                                           <td>Rs  <?= $myorder->product_price ?></td>
                                           <td>Rs  <?= $myorder->total_price ?></td>
                                          
                                           <td><a href="<?=base_url();?>admin_customizer?product=<?= $myorder->product_base;?>&order_design_print=<?= $myorder->id ?>"target="_blank"><button class="btn btn-primary">Download Design <i class="fa fa-arrow-right"></i></button></a> </td>
