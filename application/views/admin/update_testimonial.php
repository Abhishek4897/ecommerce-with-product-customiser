								...
								<div class="card-block">
									<form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="designation" value="<?=$list->designation;?>" id="">
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Client say's </label>
                                            <!--<input type="text"  class="form-control" name="description" value="<?//=$list->description;?>" id="" required>-->
                                        <textarea id="summernote" class="form-control" name="description"  required > <?=$list->description;?> </textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="file" value=""  class="hidden-field" name="image" id="slider" onchange="preview(this)" >
