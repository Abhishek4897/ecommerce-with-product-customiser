							...
							<div class="card">
								<div class="card-header">
										<div class="row">
											...
											<a href="<?php echo base_url() ?>Admin/add_testimonial" class="float-right"><button class="btn btn-primary">+ Add</button></a>
											</div>
												...
												<tr>
													...
													<td>
															<img class="img-fluid img-circle user-thumbnail"
																src="<?= $l->image;?>"alt="">&nbsp;<?= $l->name;?>
													</td>
													<td>
													    <?= (empty($l->designation))?'No data found':$l->designation ;?>
													</td>
                                                    ...
                                                    <td><?= $l->description;?></td>
                                                        ...
                                                        <button
														  class="btn waves-effect waves-light btn-success btn-sm  btn-custom" type="submit" onclick="return confirm('Are you sure to Deactive ?')" name="deactive" value="testimonial">Active</button>
													  </form>  
                                                         </td>
                                                        <?php } else {?>
                                                           ...
                                                           <form action="" method="post">
													          <input type="hidden" name="id" value="<?=$l->id?>">
                                                        <button
														  class="btn waves-effect waves-light btn-info btn-sm  btn-custom" type="submit" onclick="return confirm('Are you sure to Active ?')" name="active" value="testimonial">Deactive</button>
													  </form>  
                                                         </td>
                                                        <?php }?>
													  ...
													  <td>
													      <a href="<?php echo base_url() ?>Admin/update_testimonial/<?=$l->id?>"><button
