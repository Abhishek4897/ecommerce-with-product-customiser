...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" media="only screen and (max-width: 1024px)" href="<?php echo $lumise->apply_filters('editor/responsive_designer.css', $lumise->cfg->assets_url.'assets/css/responsive_designer.css?version='.LUMISE); ?>">
  ...
  <div class="modal-dialog modal-dialog custom_modal_share" role="document">
    <div class="modal-content" style="background:#fff;border-radius:10px;padding:15px;">
      ...
      <div class="modal-body" style="padding:0px;">
        ...
        <div class="row" id="share_link_section" style="margin-top:10px; display:none;">
            ...
            <div class="col-md-3 col-xs-3 col-3 text-center" style="padding-left: 0px;" onclick="copy_in_clipboard()">
                ...
                <span style="color:#111;font-size:16px;font-weight:600;">Copy</span>
                        ...
                        <div class="modal fade" id="loginotpmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="overflow-y: hidden!important;">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <button type="button" class="close modal_remove_button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <div class="card card-signin">
                            <div class="card-body">
                                <div style="text-align:center !important">
                                <img src="<?= base_url()?>assets/logo/logo.png" alt="logo" style="height:35px; text-align:center;margin-bottom:12px">
                            </div>
                                <form class="form-signin" method="post" id="get_login">
                                    <div style="margin-top: 10px;">
                                        <button class="btn btn-lg  btn-block text-uppercase border"    onclick="googleLogin()" type="button" style="border-radius:5px;" ><i class="fab fa-google mr-2"></i> Sign in with Google</button>
                                        <button class="btn btn-lg btn-facebook btn-block text-uppercase" onclick="googleLogin()"  type="button" style="color:white !important;border-radius:5px;"><i class="fab fa-facebook-f mr-2"></i> Sign in with Facebook</button>
                                    </div>
                                    <button class="btn btn-block text-uppercase border mt-2" type="button" onclick="mobile_login()" style="border-radius:5px;">Continue With phone number</button>
                                    ...
                                    <div style="display:flex !important;">
                                        <a href="<?=base_url('forgot_password')?>" style="font-size:15px;color:black;font-weight:600">Forgot your password?</a>
        ...
        <div class="modal fade" id="mobileloginotpmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="overflow-y: hidden!important;">
                            ...
                            <div class="card-body">
                                ...
                                <form  method="post" id="get_otp">
                                    <div class="form-group mt-4 mb-4">
                                        ...
                                        <span class="float-right" data-toggle="modal" data-dismiss="modal" aria-label="Close"  data-target="#loginotpmodal" style="cursor:pointer;font-weight:bold">Login with Email</span>
                                      </div>
                                    <center><p class="mt-3" style="font-size: 14px; line-height: 18px;">By logging in, you are agreeing to Arteno’s privacy policy and terms of use</p></center>
                                       <br>
                                    <button type="submit"  class="btn btn-primary text-uppercase checkout-button btn-block" style="border-radius:0px; font-size: 16px;">Login</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="otpverificationmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="overflow-y: hidden!important;">
            <div class="modal-dialog modal-dialog-centered modal-md custum-modal-height" role="document" style="">
                <div class="modal-content">
                    <div class="modal-body">
                        <button type="button" class="close modal_remove_button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <div class="card card-signin">
                            <div class="card-body">
                                <div style="text-align:center !important">
                                    <img src="<?= base_url()?>assets/logo/logo.png" alt="logo" style="height: 60px; margin-top: -4px; text-align:center;">
                                </div>
