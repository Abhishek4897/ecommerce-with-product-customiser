<?php
require_once __DIR__.'/RazorpayLIB.php';
...
class RazorpaySDK
{
	...
	public function __construct()
	{
	   ...
	   //live key
	   // key_id,key_secret
      //  rzp_live_ImjMvZk2cbVUwr,iSkV4jyNfCa39FwkbT9ullJD
    
    //     test key
    //     $api_key = "rzp_test_i7AoJuy98WjL5L";
	   //$api_secret = "8QubE2NHsSrQNYSqXBKDimpg";
	   
	   // $api_key = "rzp_live_ImjMvZk2cbVUwr";
	   // $api_secret = "iSkV4jyNfCa39FwkbT9ullJD";
	    $api_key = "rzp_live_ZI7Ls1AddVuEdF";
	    $api_secret = "G2oZHFAPk8q2mDd7IEfOvkdw";
		$this->api = new Api($api_key, $api_secret);
	}
	
	public function add_order($reciept_id, $amt) { //array('receipt' => '123', 'amount' => 100, 'currency' => 'INR')
	    $data = array(
	        'receipt' => 'order_rcptid_'.$reciept_id,
	        'amount'  => $amt*100,
	        'currency' => 'INR'
	        );
	    return $this->api->order->create($data)['id'];
	}

	public function verify_signature($attributes) {//$razorpay_signature, $razorpay_payment_id, $order_id
	   // $attributes  = array(
