...
<ul data-block="left" data-resp="file">
	...
	<!--			<i class="designerx-android-close close" title="<?php echo $this_main->lang('Close'); ?>"></i>-->
...
// 		&& $this_main->cfg->settings['user_print'] != '1'
	...
	<!-- To add your code here, use the hook $this_main->add_action('before_language', function(){}) -->
