...
<style>
	...
	<ul class="designer-top-nav left" data-mode="group" data-grouped="false" style="display:none">
			...
			<ul data-pos="left" data-view="sub">
				<li data-view="title">
					...
					<p class="flex">
						...
						<span class="designer-save-color" style="float:right" data-tip="false" data-target="svg-fill" tile="Save this color">
	...
	<ul class="designer-top-nav left" data-mode="image">
		...
		<li data-tool="callback" data-callback="replace" style="display:none">
			<span data-tip="true" data-pos="bottom">
				<i class="fa fa-upload"></i>
				<span><?php echo $this_main->lang('Replace image'); ?></span>
			</span>
		</li>
		<li data-tool="callback" data-callback="crop" style="display:none">
			<span data-tip="true" data-pos="bottom">
				<i class="fa fa-crop"></i>
				<span><?php echo $this_main->lang('Crop'); ?></span>
			</span>
		</li>
		<li data-tool="masks" data-callback="select_mask" style="display:none">
			<span data-tip="true" data-pos="bottom">
		...
		<li data-tool="filter" style="display:none">
			<span data-tip="true">
		...
		<!--	</ul>-->
		<!--</li>-->
		<li data-tool="callback" data-callback="imageFXReset" style="display:none">
...
<style>
    ...
    /*[data-tool="qrcode-text"]>[data-pos="right"]{*/
    ...
    .mobile-qr-editor{
     ...
     div#designer-top-tools[data-view="qrcode"] ul.designer-top-nav[data-mode="standard"]{
         margin-top:0%;
     }
     
    /*  .qrcode-text .fa-qrcode,#designer-qrcode-text{*/
    /*    display:none!important;*/
    /*}*/
     div#designer-top-tools>ul.designer-top-nav>li[data-tool="qrcode-text"]  .fa-qrcode{display:none!important;}
	...
	<ul class="designer-top-nav left" data-mode="standard">
		...
		<li data-tool="qrcode-text">
			<span data-tip="true">
				<i class="fa fa-pencil mobile-qr-editor" id="mobile-qr-pencil"></i>
				<span><?php echo $this_main->lang('Edit text'); ?></span>
			</span>
			<ul data-pos="right" data-view="sub" id="qredit" class="d-sm-none d-md-none d-lg-none">
				<li data-view="title">
					<h3>
						<?php echo $this_main->lang('Edit text'); ?>
						<i class="fa fa-times close" title="Close" style="color:#111;"></i>
					</h3>
				</li>
				<li>
					<h3 class="nob">
						<textarea type="text" id="qr_textarea" class="nol designer-edit-text" style="background-color:#fff;" placeholder="Your QR Code text"></textarea>
					</h3> 
				</li>
			</ul>
			<span data-tip="true">
				...
				<input type="text" class="designer-edit-text" id="designer-qrcode-text" placeholder="<?php echo $this_main->lang('Enter your text'); ?>" />
			</span>
		</li>
	...
	<ul class="designer-top-nav left" data-mode="text" id="designer-text-tools">
		...
		<li data-tool="font">
			...
			<ul data-pos="center" class="font-drower" data-func="fonts" data-view="sub">
		...
		<li data-tool="spacing">
			...
			<ul data-pos="right" class="text-edit edit_your_text" data-view="sub">
				<li data-view="title">
					<h3>
						<?php echo $this_main->lang('Edit text'); ?>
						<i class="fa fa-times close" title="Close"></i>
				...
				<li>
					<h3 class="nob">
						<textarea type="text" class="nol designer-edit-text" placeholder="Enter your text"></textarea> <button data-func="update-text-fx"><?php echo $this_main->lang('UPDATE TEXT'); ?></button>
				
					
						<span onclick="view_more_text()" id="view_more_text" class="designer-save-color" data-tip="false" style="float:right"  title=""><i class="fa fa-plus show_hide"></i></span>
						
						    <span onclick="view_less_text()" id="view_less_text" style="display:none;float:right" class="designer-save-color"><i class="fa fa-minus show_hide"></i></span>
						</li>
					</h3> 
						<li>
				</li>
		...
		<li data-tool="text-effect" style="display:none;">
			<span data-tip="true">
				<i class="lumisex-vector" style="font-size:24px;color:black;font-weight:bold"></i>
			...
			<ul data-pos="right" data-view="sub">
				...
				<li id="designer-text-effect">
					<h3 class="nob mb1">
						<textarea type="text" class="nol ml0 designer-edit-text" placeholder="<?php echo $this_main->lang('Enter your text'); ?>" style="width: 82%;"></textarea>
						<button data-func="update-text-fx"><?php echo $this_main->lang('UPDATE TEXT'); ?></button>
					<button onclick="view_more_effects()" id="view_more_effects" class="btn btn-primary" style="background: #dbb258;min-width:0px!important;height:35px;margin:auto;"><i class="fa fa-plus show_hide" style="margin: 3px 0px 0px 0!important;position:inherit;color:#fff;"></i></button>
					<button onclick="view_less_effects()" id="view_less_effects" style="display:none;background: #dbb258;min-width:0px!important;height:35px;margin:auto;;" class="btn btn-primary"><i class="fa fa-plus show_hide" style="margin: 3px 0px 0px 0!important;position:inherit;color:#fff;"></i></button>
		...
		<li class="sp"></li>
		<li data-tool="text-align" style="display:none">
			<span data-tip="true">
		...
		<li class="text-format" data-format="upper" style="display:none">
			<span data-tip="true">
	...
	<!--<ul class="designer-top-nav left" data-mode="standard">-->
	    <ul class="designer-top-nav left" data-mode="text">
		<!-- Avalable hook: before-tool-standard-right -->
			<li data-tool="fill" class="colorFiller" style="display:block">
			<span data-tip="true">
			...
			<ul data-pos="center" data-view="sub" id="fill-ops-sub">
				<li data-view="title">
					<h3>
					    ...
					    <label for="designer-fill" id="color-picker-label" onclick="callColorpicker()" style="">Color Palette</label>
						<!--<input type="text" placeholder="click to choose color" id="designer-fill"  title="Color Palette" class="color"  style="padding: 0px 125px 0px 0px;" data-pos="#fill-ops-sub"/>-->
						<input type="text" placeholder="Choose Colour" id="designer-fill"  title="Color Palette" class="color"  />
						
							<!--<button type="button" class="btn-sm" style="float:right">Color Palette</button>-->
						<?php if ($this_main->cfg->settings['enable_colors'] != '0') { ?>
				...
				<!--</li>-->
				<style>
				    div#designer-workspace .designer-save-color{
				        float:right;
				    }
				</style>
		...
		<!--	</ul>-->
		<!--</li>-->
		<li data-tool="position" style="display:none">
			<span data-tip="true">
		...
		<li data-tool="transform" style="position:absolute;visibility:hidden;left:-200px">
