...
class lumise_cfg extends lumise_tmpl_register{
    ...
    public $settings = array(
		...
		'title' => 'AnshuWap Design',
		'logo' => '',
		'favicon' => '',
		'logo_link' => 'https://anshuwap.com',
		'back_link' => '',
		'primary_color' => '',
		'conditions' => '',
    ...
    public function init() {
		...
		$lumise->cfg->api_url = $lumise->cfg->scheme.'://services.anshuwap.com/';
	    ...
	    $this->js_lang = array(
			...
			'60'=> $lumise->lang('Select design from Premium designs'),
			...
			'92'=> $lumise->lang('Search premium design'),
			'93'=> $lumise->lang('Select premium design'),
			...
			'136'=> $lumise->lang('Design loaded successfully'),
			...
			'188'=> $lumise->lang('Your design was saved at'),
			'189'=> $lumise->lang('Your designs was not saved'),
