...
// 	$logo = $cfg->settings['logo'];
	$logo = "https://arteno.in/assets/logo/artenologo.png";
...
// 		&& $this_main->cfg->settings['user_print'] != '1'
	...
	?><li data-tool="print"<?=$alwd;?>>
		<span><?php echo $this_main->lang('Print'); ?></span>
...
<ul data-block="right">
	...
	<li data-tool="cart" id="designer-cart-options">
		<button id="designer-addToCart" title="<?php echo $this_main->lang('My cart'); ?>">
	...
	<li id="designer-proceed" style="margin-top: 10px;">
	...
	?>
	<li data-tool="proceed" data-callback="proceed" id="designer-proceed">
		<span>
