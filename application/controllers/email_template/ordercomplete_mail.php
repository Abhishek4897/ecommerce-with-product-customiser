        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin:0px">
          <tbody><tr>
            <td>
               <center>
                    <br>
            <img src="'.$status_img.'" style="width:100%;height:120px;margin-bottom:40px">
            <br><br>
              <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin:0px">
                    ...
                    <tbody>
                      <td align="left" style="font-size:0px;padding:0px 10px;word-break:break-word">
                        ...
                        Your Order (ID: '.$site_setting->order_prefix.$order_id.') has been successfully completed!<br/>
                        Hi there! <br/>We are pleased to notify you that your order has been successfully delivered to you!<br>
 Thank you for shopping with us! We hope to see you soon.<br/>

Cheers!<br/>
Team Arteno
                        </div>
                        <br>
                        <center><a href="https://forms.gle/1XoTiMorg4PG6cXj7" ><button style="border:none;padding:10px 20px 10px 20px;background:red;color:white;font-weight:700">RATE YOUR EXPERIENCE</button></a></center>
                    </td>
                    </tr>
