...
$site_setting=$this->db->where('id',1)->get('invoice-details')->row();
    $msg='<div style="background-color:rgb(242,242,242)">
      ...
      <img  src="'.$site_setting->invoicelogo.'" style="transform: scale(2);border:0px;display:block;outline:none;text-decoration:none;height:120x;width:100%;font-size:13px" width="120" class="CToWUd">
            ...
            <td>
              <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin:0px">
                    ...
                    <tbody><tr>
                      ...
                      <td align="left" style="font-size:0px;padding:0px 10px 8px;word-break:break-word">
                        <br>
                        
      <div style="font-family:&quot;Source Sans Pro&quot;,sans-serif;font-size:20px;font-weight:700;line-height:1;margin-top;5x;text-align:left;color:rgb(40,44,63)">Hello <strong><i>'.$user->user_fullname.'</i></strong>,</div>
      ...
      <div style="font-family:&quot;Source Sans Pro&quot;,sans-serif;font-size:16px;line-height:21px;text-align:left;color:rgb(40,44,63)">
      <span style="text-align:justify;">You indicates that you forgot your password. Click the button below to reset your Arteno account password.</span> 
      <br>
      <center>
      <a href="'.base_url().'reset_request/'.$encodeemail.'/'.$token.'">
      <button class="btn btn-primary" style="background-color:#000;color:#fff;padding: 10px;border-radius: 2px;border: 1px solid #111;">Reset Password</button></a></center>
          </div>
