<?php
    ...
    $msg='<div style="background-color:rgb(242,242,242)">
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin:0px">
                    ...
                    <tbody><tr>
                      ...
                      <td align="left" style="font-size:0px;padding:0px 10px 8px;word-break:break-word">
                        <br>
                        <center>
                            <img src="'.$status_img.'" style="width:100%;height:80px">
                        </center><br><br>
      <div style="font-family:&quot;Source Sans Pro&quot;,sans-serif;font-size:14px;line-height:1;margin-top;5x;text-align:left;color:rgb(40,44,63)">Hi <strong><i>'.$user->user_fullname.'</i></strong>,</div>
      ...
      Thank you so much for placing your order with Arteno! We highly appreciate your constant support. An order confirmation has been sent to your provided mobile number as well. Once your order has been shipped, you will receive an email to the email ID provided by you along with an SMS to your mobile number.
        <br/>
        Please keep in mind that government lockdown guidelines are being followed for shipping.
          </div>
